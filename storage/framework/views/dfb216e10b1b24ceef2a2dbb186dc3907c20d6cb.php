           ...
           <div class="form-group">
              ...
              <input type="checkbox" id="condition" name="condition" value="yes">
               <label for="condition">Terms and Conditions</label><br>
                    <input type="text" id="custome" class="form-control" name="hgh">
...
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\SERVER\htdocs\project\AB-Ceramic-Industries\resources\views/admin/cashmemo/cashmemonw.blade.php ENDPATH**/ ?>