          ...
          <div class="card bg-dark">
            ...
            <div class="card-header">
              <div style="display:inline-block; padding-top:5px;">
                <i class="fa fa-plus-circle"></i> Edit Product Details 
              </div> 
            </div>
              ...
              <div class="row">
                   ...
                   <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <select class="form-control" name="grade">
                          	<option value="<?php echo e($productdetails->grade); ?>"><?php echo e($productdetails->grade); ?></option>
                   ...
                   <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <select name="bonus_option" class="form-control">
                            <option value="<?php echo e($productdetails->bonus_option); ?>"><?php echo e($productdetails->bonus_option); ?></option>
                            <option>Yes</option>
                            <option>No</option>
                          </select>
                      </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input type="text" value="<?php echo $productdetails->date; ?>" name="date" class="form-control" placeholder=" ENTR bonus  ">
                      </div>
                  </div>
...
<script type="text/javascript">
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/experthost/public_html/ab/AB-Ceramic-Industries/resources/views/admin/product/productedit.blade.php ENDPATH**/ ?>