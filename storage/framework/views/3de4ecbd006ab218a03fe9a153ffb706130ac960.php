...
<div class="raees-spinner-wrap">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <div class="row">
        ...
        ->first();   ?>
              <?php $__currentLoopData = $cashmemo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <td class="noprint">
                        ...
                        <?php if($data->sms_status==1): ?>
                         ...
                         <?php if($count == 11): ?>
                          ...
                          <a href="<?php echo e(url('admin/otpmessage/'.$data->id)); ?>"  class="btn btn-info btn-sm waves-effect waves-light"> 
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\AB-Ceramic-Industries (3)\AB-Ceramic-Industries\resources\views/admin/cashmemo/cashmemo.blade.php ENDPATH**/ ?>