             ...
             <input type="hidden" name="id" id="id">           
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="qty" name="quantity" placeholder="quantity">
                  </div>
                </div>
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="quantity_percartoon" name="quantity_percartoon" placeholder="Quantity Per Cartoon">
                  </div>
                </div>
               ...
               <div  class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input class="form-control"  value="<?php echo e($total_cartoon); ?>" readonly=""  type="text" id="ctn_pcs_t" name="ctn_pcs_t" placeholder="" >
                      </div>
                 ...
                 <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input class="form-control"  type="text" id="tt_deposit_balance" name="tt_deposit_balance" placeholder="TT/Deposit balance" required="">
                      </div>
                 </div>
                 <div class="col-md-2"></div>
      ...
      <div class="row" style="margin-top: 15px;">
        ...
        <div class="col-md-6">
         ...
         <div class="col-md-6">
              ...
              <div class="col-md-12">
                  <div class="form-group">
                      <button onclick="var e=this;setTimeout(function(){e.disabled=true;},0);return true;" type="submit" class="btn btn-block btn-dark">
...
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\AB-Ceramic-Industries (3)\AB-Ceramic-Industries\resources\views/admin/cashmemo/cashmemonw.blade.php ENDPATH**/ ?>