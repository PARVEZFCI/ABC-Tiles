...
<div class="clearfix"></div>
      ...
      <div class="row">
        <div class="col-12 col-lg-12 col-xl-12">
          ...
          <div class="card " style="margin-bottom: 0px; background: #febe10;">
              ...
              <span> Welcome, AB Ceramic Industries &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span> <span style="text-align: right;" class="text-right">Total Message:   <?php echo e($setting->Total_message); ?></span>
           </div>
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\AB-Ceramic-Industries (3)\AB-Ceramic-Industries\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>